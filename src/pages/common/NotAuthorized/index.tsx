...
export default function NotFound() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#2F2E79] text-white font-sans">
            ...
            <h1 className="text-4xl font-bold m-0">Acesso Negado</h1>
